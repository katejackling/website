...
function (_Component) {
  ...
  function MuxVideoInput(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "blur", function () {
      _this2.setState({
        hasFocus: false
      });
    });

    _defineProperty(_assertThisInitialized(_this2), "pollMux", function () {
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleSetupButtonClicked", function (event) {
      _this2.setState({
        showSetup: true
      });
    });

    _defineProperty(_assertThisInitialized(_this2), "handleSaveSetup", function (_ref2) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleCancelSaveSetup", function () {
      _this2.setState({
        showSetup: false
      });
    });

    _defineProperty(_assertThisInitialized(_this2), "handleOnUploadComplete", function (result) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleRemoveVideoButtonClicked", function (event) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleRemoveVideo", function (event) {
      var onChange = _this2.props.onChange;
      var assetDocument = _this2.state.assetDocument;
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleCancelRemove", function (event) {
      _this2.setState({
        confirmRemove: false,
        deleteOnMuxChecked: true,
        deleteAssetDocumentChecked: true
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleDeleteOnMuxCheckBoxClicked", function (event) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleDeleteAssetDocumentCheckBoxClicked", function (event) {
      _this2.setState(function (prevState) {
        return {
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleSetThumbButton", function (event) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleErrorClose", function (event) {
      if (event) {
        event.preventDefault();
      }
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleCloseThumbPreview", function (event) {
      _this2.setState({
        thumb: null
      });
    });

    _defineProperty(_assertThisInitialized(_this2), "handleBrowseButton", function (event) {
      _this2.setState({
        showBrowser: true
      });
    });

    _defineProperty(_assertThisInitialized(_this2), "handleCloseBrowser", function (event) {
      _this2.setState({
        showBrowser: false
      });
    });

    _defineProperty(_assertThisInitialized(_this2), "handleSelectAsset", function (asset) {
      var onChange = _this2.props.onChange;
      onChange(_patchEvent.default.from([(0, _patchEvent.setIfMissing)({
        asset: {
          _ref: asset._id
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleVideoReadyToPlay", function () {
      _this2.setState({
