...
function (_Component) {
  ...
  function MuxVideoInputUploader() {
    ...
    _defineProperty(_assertThisInitialized(_this), "dragEnteredEls", []);

    _defineProperty(_assertThisInitialized(_this), "upload", null);

    _defineProperty(_assertThisInitialized(_this), "ctrlDown", false);

    _defineProperty(_assertThisInitialized(_this), "cancelUploadButton", _react.default.createRef());

    _defineProperty(_assertThisInitialized(_this), "hiddenTextField", _react.default.createRef());

    _defineProperty(_assertThisInitialized(_this), "container", _react.default.createRef());

    _defineProperty(_assertThisInitialized(_this), "subscribeToUpload", function (upload, callback) {
      _this.setState({
        invalidFile: false,
        invalidPaste: false,
        error: null
    ...
    _defineProperty(_assertThisInitialized(_this), "trackProgress", function (evt) {
      _this.setState({
        uploadState: evt.percent
      });
    });

    _defineProperty(_assertThisInitialized(_this), "handleUploadFiles", function (files) {
      _this.setState({
        uploadState: 0
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleUploadResponse", function (response, callback) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleUploadEvent", function (event, callback) {
      switch (event.type) {
        case 'response':
    ...
    _defineProperty(_assertThisInitialized(_this), "handleUploadSuccess", function (response, callback) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleUploadError", function (error, callback) {
      if (error) {
        _this.setState({
          error: error,
          isComplete: true
    ...
    _defineProperty(_assertThisInitialized(_this), "handleCancelUploadButtonClicked", function (event) {
      _this.setState({
        uploadState: null,
        error: null
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleErrorClose", function (event) {
      if (event) {
        event.preventDefault();
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSetupButtonClicked", function (event) {
