...
function (_Component) {
  ...
  function MuxVideo() {
    ...
    _defineProperty(_assertThisInitialized(_this), "videoContainer", _react.default.createRef());

    _defineProperty(_assertThisInitialized(_this), "hls", null);

    _defineProperty(_assertThisInitialized(_this), "handleVideoClick", function (event) {
      _this.setState({
        showControls: true
      });
