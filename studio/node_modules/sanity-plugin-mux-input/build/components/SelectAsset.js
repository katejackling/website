...
function (_React$Component) {
  ...
  function SelectAsset() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SelectAsset)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "pageNo", 0);

    _defineProperty(_assertThisInitialized(_this), "handleItemClick", function (event) {
      event.preventDefault();

      _this.select(event.currentTarget.getAttribute('data-id'));
    });

    _defineProperty(_assertThisInitialized(_this), "handleItemKeyPress", function (event) {
      if (event.key === 'Enter') {
        event.preventDefault();
    ...
    _defineProperty(_assertThisInitialized(_this), "handleFetchNextPage", function () {
      _this.fetchPage(++_this.pageNo);
    });

    _defineProperty(_assertThisInitialized(_this), "handleImageError", function (event) {
